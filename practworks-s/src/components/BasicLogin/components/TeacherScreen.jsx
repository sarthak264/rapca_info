...
const TeacherScreen = (props) => {
  ...
  function callback(key) {
    if (key === "2") {
      props.history.push(RouteDefinitons.ROUTE_TEACHER_LOGIN);
    } else {
      props.history.push(RouteDefinitons.ROUTE_TEACHER_SIGNUP);
    }
  }
  return (
    <div className="pt-10">
      <Tabs
        defaultActiveKey={
          path === RouteDefinitons.ROUTE_TEACHER_LOGIN ? "2" : "1"
        }
        onChange={callback}
        className="fs-18 Monts-Bold"
      >
        <TabPane tab="First Time Teacher" key="1">
          {/* Sign up form */}
        ...
        <TabPane tab="Login" key="2">
          ...
          <Form
            ...
            onFinish={(values) => props.onFinish(values, "teacher")}
            layout="vertical"
          >
            <Form.Item
              name="phone"
          ...
          <div className="text-center fs-14 pt-10 Monts-Medium">
            ...
            <a
              href={RouteDefinitons.ROUTE_TEACHER_SIGNUP}
              className="text-center fs-14 pt-10 Monts-Bold"
              style={{ color: "#4d6898" }}
            >
              Register Now
